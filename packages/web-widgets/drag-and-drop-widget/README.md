...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/exm1demo.gif" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            Example 1 Demo
  ...
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/ex1m.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            Example 1 On Page
  ...
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/ex1micro.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            Example 1 Microflow
...
-   STEP 0️⃣ - _Import the Example Module into your project_
    ...
    **It is advised to auto generate the `uuid` and `sortvalues` on save, as the user creates the item, for demo
    ...
    <table style="width:100%">
        <tr>
            <td  style="width:50%">
                <img align="center" width="550" alt="headerIMG" src="./assets/communication.png" target="_blank" /></td>
            <td>
            <table style="width:100%">
                <tr>
...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/json.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            <th>Name</th>
...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/actions.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            <th>Name</th>
...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example1/a11y.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            <th>Name</th>
...
<table style="width:100%">
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2demo.gif" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
                Example 2 Demo
    ...
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2page.png" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
                Example 2 on Page
    ...
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2db.png" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
    ...
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2pm.png" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
    ...
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2csp.png" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
    ...
    <tr>
        <td  style="width:50%">
            <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2cdp.png" target="_blank" /></td>
        <td>
        <table style="width:100%">
            <tr>
...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2pa.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
  ...
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2pd.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
...
<table style="width:100%">
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2ca.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            <th>Parent Actions Settings</th>
  ...
  <tr>
    <td  style="width:50%">
    <img align="center" width="550" alt="headerIMG" src="./assets/example2/ex2cd.png" target="_blank" /></td>
    <td>
    <table style="width:100%">
        <tr>
            <th>Parent Data and UUID Settings</th>
